...
public class TestNonTerminalNodeEvents{
  ...
  public void testReceiveMetaIdentifierEvent(){
    ...
    NodeListeners.assign("meta identifier", startNode, e -> nodeName = e.getNode().name);
  ...
  public void testReceiveLetterEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("letter", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveMetaIdentifyingCharacterEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("meta identifying character", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveDefiningSymbolEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("defining symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveDefinitionsListEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("definitions list", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveSingleDefinitionEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("single definition", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveSyntacticTermEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("syntactic term", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"","a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveSyntacticFactorEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("syntactic factor", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveIntegerEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("integer", startNode, e -> nodeName = e.getNode().name);
  ...
  public void testReceiveSyntacticPrimaryEvent(){
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("syntactic primary", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N","T","N","=","2","5","*","\"", "a","\"", ",", "\"","b","\"",";"), startNode);
  ...
  public void testReceiveTerminalStringEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("terminal string", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "2", "5", "*", "\"", "a","\"", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveFirstQuoteSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("first quote symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "2", "5", "*", "\"", "a","\"", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveFirstTerminalCharacterEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("first terminal character", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "2", "5", "*", "\"", "a","\"", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveSecondQuoteSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("second quote symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "2", "5", "*", "'", "a","'", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveSecondTerminalCharacterEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("second terminal character", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "2", "5", "*", "'", "a","'", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveSpecialSequenceEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("special sequence", startNode, e -> nodeName = e.getNode().name);
  ...
  public void testReceiveSpecialSequenceCharacterEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("special sequence character", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "?","B","M","P","?",",","'","a","'", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveSpecialSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("special symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "?","B","M","P","?",",","'","a","'", ",", "\"","b","\"", ";"), startNode);
  ...
  public void testReceiveOptionalSequenceEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("optional sequence", startNode, e -> nodeName = e.getNode().name);
  ...
  public void testReceiveStartOptionSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("start option symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "[","A",",","B","]",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveEndOptionSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("end option symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "[","A",",","B","]",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveRepeatedSequenceEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("repeated sequence", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "{","A",",","B","}",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveStartRepeatSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("start repeat symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "{","A",",","B","}",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveEndRepeatSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("end repeat symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "{","A",",","B","}",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveGroupedSequenceEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("grouped sequence", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "(","A",",","B",")",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveStartGroupSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("start group symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "(","A",",","B",")",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveEndGroupSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("end group symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "(","A",",","B",")",",","'","a","'",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveDefinitionSeparatorSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("definition separator symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "\"","a","\"","|","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveConcatenateSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("concatenate symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "\"","a","\"",",","\"","b","\"", ";"), startNode);
  ...
  public void testReceiveExceptSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("except symbol", startNode, e -> nodeName = e.getNode().name);
  ...
  public void testReceiveTerminatorSymbolEvent() {
    ParseNode startNode = EbnfParseTree.getStartNode();
    NodeListeners.assign("terminator symbol", startNode, e -> nodeName = e.getNode().name);
    parser.parse(TokenQueue.ofList("N", "T", "N", "=", "A","B","C","-","\"","b","\"", ";"), startNode);
